...
export default function QuestionUpload({ 
  ...
  // --- All state and logic is IDENTICAL to your original code ---
          ...
          {currentCredits < 1 && (
            <div className="absolute inset-0 bg-white/70 backdrop-blur-sm z-10 rounded-2xl flex flex-col items-center justify-center text-center p-4">
               <div className="p-4 bg-blue-100 rounded-full mb-4 border border-blue-200">
                 <Gem className="size-10 text-blue-600" />
               </div>
  ...
  return (
    <div className="w-full bg-slate-50 p-4 sm:p-8 rounded-2xl">
      <Card className="w-full max-w-4xl mx-auto shadow-2xl shadow-slate-200/70 border border-slate-200/80">
